...
<?php VerifyEmailOtp(); ?>
					...
					<div style="margin-bottom:100px;">
						<center>
						<p style="color:#030002;"> <strong>OTP send on <?php print_r($_SESSION['email']); ?></strong></p>
						</center>
						<form method="post" action="" >
							<div style="margin-bottom:20px; margin-top:40px;">
								<div class="md-form">
									<input type="password" name="otp_code" style="text-align: center;" id="form1" class="form-control" placeholder="Enter OTP">
								</div>
							</div>
							<center >
							<input  type=submit name="cancel"  value="Cancel" class="btn purple-gradient btn-lg pull-left" >
							<input  type="submit" name="otp_email"  value="Continue" class="btn aqua-gradient btn-lg pull-right" >
							</center>
