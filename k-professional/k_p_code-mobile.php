      ...
      <div id="login-row" class="row justify-content-center align-items-center">
        <div id="login-column" class="col-md-6">
          <div id="login-box" class="col-md-12">
            ...
            <center>
            <p style="color:#030002;"> <strong>OTP send on <?php print_r($_SESSION['mb_no']); ?></strong> </p>
            </center>
            <center>
<?php mobile_otp_validation(); ?>
<?php display_message(); ?>
            </center>
            <form id="login-form" class="form" style="margin-top: 20px;" action="" method="post" autocomplete="off">
              <div class="md-form">
                <input type="password" style="text-align: center;" name="mobile_otp" id="form1" class="form-control" placeholder="Enter OTP">
              </div>
