  ...
  <div class="content-page">
    <div class="content">
      <div class="container-fluid">
        ...
        <a href="page-employee-request.php" class="btn btn-primary" style="margin-bottom: 20px;" type="button"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
<?php
function exits_id($e_id)
{
    $sql    = "SELECT * FROM employee_request WHERE id = $e_id";
    $result = query($sql);
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6" >
                                <ul class="ace-thumbnails" style="margin-top:50px;">
                                  <li>
                                    <a href="../k-professional/uploads/<?php echo $q_img_f; ?>" target="_blank" data-rel="colorbox">
                                  ...
                                  <li>
                                    <a href="../k-professional/uploads/<?php echo $q_img_b; ?>" data-rel="colorbox">
...
?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <ul class="ace-thumbnails" style="margin-top:50px;">
                                  <li>
                                    <a href="../k-professional/uploads/<?php echo $card_img_f; ?>" target="_blank" data-rel="colorbox">
                                  ...
                                  <li>
                                    <a href="../k-professional/uploads/<?php echo $card_img_b; ?>" target="_blank"  data-rel="colorbox">
                          ...
                          <div id="pictures3" class="tab-pane">
                            ...
                            <ul class="ace-thumbnails">
                              <li>
                                <a href="../k-professional/uploads/<?php echo $p_img_1; ?>" data-rel="colorbox">
                              ...
                              <li>
                                <a href="../k-professional/uploads/<?php echo $p_img_2; ?>" target="_blank" data-rel="colorbox">
                              ...
                              <li>
                                <a href="../k-professional/uploads/<?php echo $p_img_3; ?>" data-rel="colorbox" target="_blank">
                              ...
                              <li>
                                <a href="../k-professional/uploads/<?php echo $p_img_4; ?>" data-rel="colorbox" target="_blank">
