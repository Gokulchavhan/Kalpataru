...
<script src="https://code.jquery.com/jquery-2.1.3.min.js"></script>
  ...
  <link rel="stylesheet" type="text/css" href="css/service_details.css">
...
<?php 
  ...
  if(isset($_GET['id'])){ 
    $id = $_GET['id'];
    $id = decode($id);
    $sql123 ="SELECT * FROM services WHERE id = '$id'";
    $result123=(query($sql123));
    $row123=fetch_array($result123);
    $name = $row123["name"];
  }
      ...
      <div class="banner_content">
        <div class="row text-left">
          <div class="col-md-8 col-sm-8 col-xs-12">
            <h1 class="service-heading">Best Professional Services in Your City</h1>
            <p>
              <li>Mechanized Equipment & Professional Service solutions</li>
            ...
            <ul class="featurs_list">
              <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Lower up-front cost</li>
              <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Easy upgrades</li>
              <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Accessibility</li>
              <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Scalability</li>
            </ul>

            <?php 
if(loggedIn()){
  echo "<button class='md-trigger' data-modal='modal-11'>Book now</button>";
}else{
  ?>
  <button id="button-a">Book now</button>
  <?php
}
...
<script type="text/javascript">
  $('#button-a').click(function(){
    ...
    setTimeout(function() {
        swal({
            title: "Thanks for choosing kalpataru!",
            text: "You are not login. Click OK for Login!",
            type: "success"
        }, function() {
              ...
              <form class="form-horizontal" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="examplePhone" name="phone_number" placeholder="Phone" name="phone" />
                  </div>
                </div>
                   <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-bars" aria-hidden="true"></i></i></div>
                    <input type="text" class="form-control" name="subject" id="examplePhone" placeholder="Subject" name="phone" />
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                ...
                <div class="form-group">
                  <div class="quick_btn">
                    ...
                    <input type="hidden" name="id" style="background-color: #42B1E7" value="<?php echo $row123["id"]; ?>">
                    <input type="submit" name="contact" class="" style="background-color: #42B1E7" value="Send Your Message">
                  </div>
                </div>
              </form>
            </div>
...
?>
  ...
  <section id="howitwork">
    <div class="container text-center">
      <!-- <h1 class="panel-heading">Our Specialist</h1> -->
      <h1 class="panel-heading">Our Service expart</h1>
    </div>
  </section>
...
<?php 
        $sqlR1 ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND value = 1";
        $resultR1=(query($sqlR1));
        if(row_count($resultR1) > 0){
        $countR1=0;
        while($rowR1 =fetch_array($resultR1))
        {
         $countR1++;
        }
      }else{
...
<?php 
        $sqlR2 ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND value = 2";
        $resultR2 =(query($sqlR2));
        if(row_count($resultR2) > 0){
        $countR2 = 0;
        while($rowR2 =fetch_array($resultR2))
        {
         $countR2++;
        }
      }else{
...
<?php 
    $sqlR3 ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND value = 3";
        $resultR3 =(query($sqlR3));
        if(row_count($resultR3) > 0){
        $countR3 = 0;
        while($rowR3 =fetch_array($resultR3))
        {
         $countR3++;
        }
      }else{
...
<?php 
    $sqlR4 ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND value = 4";
        $resultR4 =(query($sqlR4));
        if(row_count($resultR4) > 0){
        $countR4 = 0;
        while($rowR4 =fetch_array($resultR4))
        {
         $countR4++;
        }
      }else{
...
<?php 
     $sqlR5 ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND value = 5";
        $resultR5 =(query($sqlR5));
        if(row_count($resultR5) > 0){
        $countR5 = 0;
        while($rowR5 =fetch_array($resultR5))
        {
         $countR5++;
        }
      }else{
...
<?php 
        $sqlRC ="SELECT * FROM ratting WHERE emp_id = '$emp_id' AND service_id = '$s_id' AND value <> '0'";
...
?>
        ...
        <div class="row">
          ...
          <?php }else{ ?>
            <img src="k-professional/uploads/profilePicture/<?php echo $row['profile_picture']; ?>" class="img-circle" alt="Cinque Terre" width="75" height="75">
          <?php } ?>
            <div class="review-block-name"><a href="#"><?php echo ucwords($first_name." ".$last_name); ?></a></div>
            <div class="review-block-date">Joining on <?php echo $date_time; ?><br/><!-- 1 day ago --></div>
            </center>
          </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="review-block-title">
              <?php echo $name = $row123["name"]; ?> service expart
              </div>
            <div class="review-block-description" style=" text-align: justify;"><?php echo $about; ?></div>
          </div>
              ...
              <h4><strong>Rating & Reviews</strong></h4>
                  <h5><span class="badge badge-secondary" style="background-color: green;"><?php echo "5"."/".$Ravg; ?> <i class="fa fa-star"></i></span> <?php echo $rc; ?> Ratting & <?php echo  $count1; ?> Reviews</h5>
              ...
              <div class="pull-left">
                ...
                <div class="pull-right" style="margin-left:10px;"><?php echo $countR5; ?></div>
              </div>
              ...
              <div class="pull-left">
                ...
                <div class="pull-right" style="margin-left:10px;"><?php echo $countR4; ?></div>
              </div>
              ...
              <div class="pull-left">
                ...
                <div class="pull-right" style="margin-left:10px;"><?php echo $countR3; ?></div>
              </div>
              ...
              <div class="pull-left">
                ...
                <div class="pull-right" style="margin-left:10px;"><?php echo $countR2; ?></div>
              </div>
              ...
              <div class="pull-left">
                ...
                <div class="pull-right" style="margin-left:10px;"><?php echo $countR1; ?></div>
              </div>
            </div>
        </div>
...
<div class="accordion" id="accordionExample">
  ...
  <?php if(!empty($count1)){ ?>
      ...
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree<?php echo $emp_id; ?>" aria-expanded="false" aria-controls="collapseThree">
          View all comments
        </button>
      </h5>
    </div>
  <?php } ?>
    <div id="collapseThree<?php echo $emp_id; ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
       <div class="detailBox">
    <div class="titleBox">
    ...
    <div class="commentBox">
        ...
        <p class="taskDescription">Our <i class="fa fa-check-circle"></i> certified customer.</p>
    </div>
    <div class="actionBox">
        <ul class="commentList">

<?php 
        $sqlR ="SELECT * FROM ratting WHERE emp_id = $emp_id ";
        $resultR=(query($sqlR));
        ...
        while($rowR =fetch_array($resultR))
        {
          ...
          $date_time = $rowR["date_time"];
          $user_id = $rowR["user_id"];
          // $date = date("F j, Y");   
          $date = date('F jS, Y',strtotime($date_time));

?>

<?php

$sqlE       = "SELECT * FROM users WHERE id = '$user_id'";
$resultE    = query($sqlE);
confirm($resultE);
$rowE = fetch_array($resultE);

$nameR = ucwords($rowE['fullname']);
...
?>
            <li>
                <div class="commenterImage">
                  <img src="images/ratting/unisex.png" />
                </div>
                <span class="date sub-text" style="color: #000080; font-size: 15px;">
                  <strong>
                    <?php echo $nameR; ?>
                  </strong>
                </span>
                   ...
                   <div class="commentText">
                    <p class=""><?php echo $comment; ?></p> <span class="date sub-text"><!-- on March 5th, 2014 -->on <?php echo $date; ?></span>
...
<?php 
 ...
 ?>
  ...
  <section id="howitwork" style="margin-bottom: 50px;">
    <div class="container text-center">
...
<form method="post" id="regForm" action="?">
  ...
  <div class="tab">Service Category:
...
if(isset($_GET['id'])){ 
  $id = $_GET['id'];
  $id = decode($id);
  $sql ="SELECT * FROM assign_service_category WHERE service_id = '$id' AND status = 0 AND city_status = 0 AND assign_service_status = 0";
  $result=(query($sql));
...
<input type="radio" value="{$cat_id}" name="category[]">
...
END;
      ...
      echo "<p style='color:red'>Service are not available</p>";
  }
}

?>
<!-- <input type="text" name="subrata"> -->
</div>
...
$sqlTime ="SELECT * FROM service_time WHERE status = 0";
$resultTime = (query($sqlTime));

  if(row_count($resultTime) > 0){
    while($rowTime =fetch_array($resultTime)) {

echo <<<END
<label class="radio">{$rowTime["time_to"]} - {$rowTime["time_from"]}
<input type="radio" value="{$rowTime["id"]}" name="time[]">
<span class="checkround"></span>
</label> 
END;
      ...
      echo "<p>Service Category Not available</p>";
  }

?>
</div>

<div class="tab">Select Expert:

<?php

$sqlGender ="SELECT * FROM gender WHERE status = 0";
$resultGender = (query($sqlGender));

  if(row_count($resultGender) > 0){
    while($rowGender =fetch_array($resultGender)) {

echo <<<END
<label class="radio">{$rowGender["gender"]}
<input type="radio" value="{$rowGender["id"]}" name="gender[]">
<span class="checkround"></span>
</label> 
END;
...
<div class="tab">Select Price:

<?php

$sqlPrice ="SELECT * FROM service_price WHERE status = 0 ORDER BY price ASC";
$resultPrice = (query($sqlPrice));

  if(row_count($resultPrice) > 0){
    while($rowPrice =fetch_array($resultPrice)) {

echo <<<END
<label class="radio">{$rowPrice["price"]}/- ({$rowPrice["price_name"]})
<input type="radio" value="{$rowPrice["id"]}" name="price[]">
<span class="checkround"></span>
</label> 
END;
...
<div style="float:right;">
  ...
  <button type="button" id="nextBtn" disabled="disabled" onclick="nextPrev(1); disable();">Next</button>
...
<button class="md-close" style="background-color: black; color: white;">Close me!</button>
</div>
</div>
</div>
...
<script type="text/javascript">
  $("input:radio").change(function () {$("#nextBtn").prop("disabled", false);});
</script>
